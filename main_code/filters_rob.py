...
# # 
# def SNR(lamba1_nm, lamba2_nm):
#     S1 = detected_signal_band(wavelength, lamba1_nm, lamba2_nm, instr, t_exp)
#     B1 = detected_background_band(wavelength, lamba1_nm, lamba2_nm, instr, t_exp, n_pix_aperture)
#     SNR = S1 / math.sqrt(S1+B1)
#     return SNR

# Define ranges
L1_vals = np.linspace(min_wavelength_nm, max_wavelength_nm, step_wavelength_nm)
L2_vals = np.linspace(min_wavelength_nm, max_wavelength_nm, step_wavelength_nm)
